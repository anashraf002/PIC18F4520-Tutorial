...
Mainline
	...
	rcall LoopTime			;delay 0.1ms at clear state so easily differentiate transient state 

		;here sequence1 will be 1,2,4,8 and sequence2 will be 3,6,12,9 		

		MOVLF B'00010001', sequence1
		MOVLF B'00110011', sequence2 		

logicalShiftingLoop

		copyRegister PORTC, sequence1		;display the first step
		rcall LoopTime					;wait 0.1ms
		
		copyRegister PORTC, sequence2		;this is second step
		rcall LoopTime
